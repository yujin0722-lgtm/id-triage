import {
  ...
  groupArticles
} from "./article-classifier.js?v=3.0.0";
import { loadDecision, saveDecision } from "./storage.js?v=3.0.0";
...
function createClassificationDetails(classification) {
  ...
  appendDefinitionRow(list, "このアプリの分類", `${classification.groupLabel} ／ ${classification.designLabel}`);
  appendDefinitionRow(
    list,
